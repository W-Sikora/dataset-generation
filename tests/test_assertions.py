...
from utils.assertions import has_length, not_none, is_true, not_empty
...
class TestAssertion(TestCase):
    ...
    def test_should_raise_value_error_when_list_is_none(self):
        value = None
        self.assertRaises(ValueError, not_empty, value)

    def test_should_raise_value_error_when_list_is_empty(self):
        value = []
        self.assertRaises(ValueError, not_empty, value)